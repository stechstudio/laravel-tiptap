...
@php
    $colors = [
        [
            ...
            '990000', 'B45F06', 'BF9000', '38761D', '134F5C', '0B5394', '351C75', '351C75',
            '660000', '783F04', '7F6000', '274E13', '0C343D', '0C343D', '073763', '4C1130',
        ]
    ];
@endphp
    ...
    <div x-cloak>
        <div class="bg-gray-100 rounded flex justify-between items-stretch mb-1 p-1">
            <div class="ProseMirror-toolbar flex items-center space-x-1">
                ...
                >
                    <i class="px-1.5 py-1 far fa-heading"></i>
                </button>
                <button
                type ="button"
                ...
                >
                    <i class="font-bold px-1.5 py-1 far fa-bold"></i>
                </button>
                <button
                type ="button"
                ...
                >
                    <i class="px-1.5 py-1 far fa-italic"></i>
                </button>
                ...
                >
                    <i class="px-1.5 py-1 far fa-link"></i>
                </button>
                <button
                type ="button"
                ...
                >
                    <i class="px-1.5 py-1 far fa-list-ul"></i>
                </button>
                <button
                type ="button"
                ...
                >
                    <i class="px-1.5 py-1 far fa-list-ol"></i>
                </button>
            </div>
            <div class="ProseMirror-toolbar flex items-center space-x-1">
                <button
                ...
                >
                    <i class="px-1.5 py-1 far fa-undo"></i>
                </button>
                <button
                type ="button"
                ...
                >
                    <i class="px-1.5 py-1 far fa-redo"></i>
                </button>
            </div>
        </div>
